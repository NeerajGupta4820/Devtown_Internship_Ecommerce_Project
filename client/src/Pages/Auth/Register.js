  ...
  return (
    <Layout title={"Register Ecommerce-App"}>
      ...
      <h1>Sign Up</h1>
        ...
        <div className="mb-3">
            <input type="text" value={answer} onChange={(e)=>setAnswer(e.target.value)} className="form-control" id="exampleInputEmail1" placeholder='what is favorite movie' required/>
        </div>
